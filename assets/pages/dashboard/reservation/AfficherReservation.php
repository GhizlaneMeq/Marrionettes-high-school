...
$query = "SELECT reservations.id ,reservations.date_debut, reservations.date_fin, livres.name AS livre_name , etudiants.nom AS student_name FROM reservations
JOIN livres ON reservations.livre_id = livres.id
JOIN etudiants ON reservations.etudiant_id = etudiants.id";
...
<body>
    ...
    <div class="content">
        <div class="row tab">
            ...
            <a href="AjouterReservation.php" class="btn btn-success mb-3" data-aos="fade-down" data-aos-duration="1500">add reservation</a>
                        ...
                        <div class="row no-gutters align-items-center">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <th><?php echo $rows['livre_name'] ?></th>
                                            <th><?php echo $rows['student_name'] ?></th>
                                            <td><?php echo $rows['date_debut'] ?></td>
                                            <td><?php echo $rows['date_fin'] ?></td>
                                            <td>
                                                <a href="ModifierReservation.php?id=<?= $rows['id'] ?>" class="link-dark"><i class='bx bxs-pencil fs-5 me-3'></i></a>
                                                <a href="SupprimerReservation.php?id=<?= $rows['id'] ?>" class="link-danger" onclick="return confirm('Are you sure you want to delete this reservation?');"><i class='bx bxs-user-x fs-5'></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    endwhile;
